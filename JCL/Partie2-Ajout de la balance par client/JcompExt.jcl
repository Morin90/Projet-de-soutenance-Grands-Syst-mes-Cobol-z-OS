//API6DBC JOB (ACCT#),'COMPDB2',MSGCLASS=H,REGION=4M,
...
//DDEU     DD  DSN=API6.PROJET.VENTEEU.DATA,DISP=SHR
//DDAS     DD  DSN=API6.PROJET.VENTEAS.DATA,DISP=SHR
//ETATDEM  DD  SYSOUT=*
//ETATANO  DD  SYSOUT=*
...
//SYSTSIN  DD  *
  DSN SYSTEM (DSN1)
  RUN PROGRAM(TSELLEXT) PLAN (TSELLEXT)
//
